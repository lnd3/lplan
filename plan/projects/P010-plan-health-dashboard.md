...
2026-08-30 — A029 added post-DONE: the needs-attention panel never ran the full `SchemaValidator`, only `check_references()`, so A027's and D008's new validator warnings were invisible in the live dashboard. Fixed, tested, verified live. Small enhancement to an already-complete project, not a reopening of scope — status stays DONE.
